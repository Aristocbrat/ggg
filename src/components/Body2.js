...
const Body2 = () => {
  return (
    <div className='secondPage mx-auto'>
      ...
      <div className='posses d-flex justify-content-evenly justify-content-lg-between py-md-4' data-aos="slide-left">
      ...
      <div className='d-flex flex-column flex-lg-row tri ms-lg-3 flex-wrap flex-md-row ' data-aos="slide-right">
      ...
      <div className='mt-lg-5 px-lg-4 ms-lg-2  po' data-aos="slide-right">
        <img src={rect} alt='rectangle'/>
      ...
      <div className='mt-lg-5 px-lg-4 ms-lg-5 po popo' data-aos="slide-left">
        <img src={rect} alt='rectangle'/>
